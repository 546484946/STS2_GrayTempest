...
public class ThrusterRelic : ModRelicTemplate
{
    ...
    public override async Task AfterPlayerTurnStart(PlayerChoiceContext choiceContext, Player player)
    {
        ...
        Flash();
        await PowerCmd.Apply<StrengthPower>(choiceContext, Owner.Creature, Counter, Owner.Creature, null);
        await PowerCmd.Apply<DexterityPower>(choiceContext, Owner.Creature, Counter, Owner.Creature, null);
    }
}
