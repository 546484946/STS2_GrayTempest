...
[RegisterCharacterStarterCard(typeof(GrayTempestCharacter), 4)]
public class GrayTempestStrike : ModCardTemplate
{
    public GrayTempestStrike() : base(1, CardType.Attack, CardRarity.Basic, TargetType.AnyEnemy) { }
