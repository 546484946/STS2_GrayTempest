...
public class LargeResources : ModCardTemplate
{
    public LargeResources() : base(0, CardType.Power, CardRarity.Rare, TargetType.Self) { }
    public override IEnumerable<CardKeyword> CanonicalKeywords => [GrayTempestKeywords.OneShot, GrayTempestKeywords.Recyclable];
    protected override IEnumerable<DynamicVar> CanonicalVars => [new IntVar("ReconstructValue", 6), new IntVar("GoldAmount", 60)];
    ...
    {
        DynamicVars["ReconstructValue"].UpgradeValueBy(3);
        DynamicVars["GoldAmount"].UpgradeValueBy(30);
    }
}
