...
public class SomeResources : ModCardTemplate
{
    public SomeResources() : base(0, CardType.Power, CardRarity.Uncommon, TargetType.Self) { }
    public override IEnumerable<CardKeyword> CanonicalKeywords => [GrayTempestKeywords.OneShot, GrayTempestKeywords.Recyclable];
    protected override IEnumerable<DynamicVar> CanonicalVars => [new IntVar("ReconstructValue", 4), new IntVar("GoldAmount", 40)];
    ...
    {
        DynamicVars["ReconstructValue"].UpgradeValueBy(2);
        DynamicVars["GoldAmount"].UpgradeValueBy(20);
    }
}
